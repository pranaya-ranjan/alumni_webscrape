from src.main.utils import constants as c
...
class Education(Institution):
    ...
    def __init__(self, from_date=None, to_date=None, description=None, degree=None, major=None):
        self.from_date = from_date
        self.to_date = to_date
        self.description = description
        self.degree = degree
    ...
    def __repr__(self):
        return "{degree} in {major} at {company} from {from_date} to {to_date}".format(
            from_date=self.from_date,
            to_date=self.to_date,
            degree=self.degree,
            company=self.institution_name,
